...
- **tone:** простой человеческий язык, по-человечески для не-программистов, без корпоративной воды и сложного снобизма. Моментальная расшифровка любых сложных терминов (RAG, API, Docker) «на пальцах» на простых аналогиях.
- **audience:** предприниматели, новички, менеджеры, специалисты разного уровня (материал должен быть кристально понятен человеку без технического бэкграунда)
